                    ...
                    <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                        ...
                        <div class="form-check">
                          ...
                          <label class="form-check-label" for="exampleRadios1">
                            ...
                            <div class="form-group{{ $errors->has('sclass_id') ? ' has-error' : '' }}">
                                <label for="sclass_id" class="col-md-4 control-label">s-Class ID</label>

                                <div class="col-md-6">
                                    <input id="sclass_id" type="text" class="form-control" name="sclass_id" value="{{ old('sclass_id') }}" required autofocus>

                                    @if ($errors->has('sclass_id'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('sclass_id') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
